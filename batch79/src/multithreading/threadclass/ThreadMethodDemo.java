...
public class ThreadMethodDemo {
	...
	public static void main(String[] args) {
		Threadclass threadOne = new Threadclass(5, "First"); // creating child thread object
		Threadclass threadTwo = new Threadclass(10, "Second"); // creating child thread object
